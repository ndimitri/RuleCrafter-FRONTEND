...
import {CampaignCreationHomeComponent} from './pages/viewDTO/campaign-creation-home/campaign-creation-home.component';
...
const routes: Routes = [
  ...
  {path: 'campaignCreation/home', component: CampaignCreationHomeComponent},
];
